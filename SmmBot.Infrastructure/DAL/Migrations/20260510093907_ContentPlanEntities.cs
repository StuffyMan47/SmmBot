...
{
    /// <inheritdoc />
    public partial class ContentPlanEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContentPlans", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ContentPlanId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_ContentPlans_ContentPlanId",
                        column: x => x.ContentPlanId,
                        principalTable: "ContentPlans",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Posts_ContentPlanId",
                table: "Posts",
                column: "ContentPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_PostStatistics_PostId",
